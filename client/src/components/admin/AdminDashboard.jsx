            ...
            <div className="cards-grid">
              <div className="dashboard-card">
                ...
                <div className="card-value">
                  {AdminDashboardData.data?.stats?.totalUsers}
                </div>
              ...
              <div className="dashboard-card">
                ...
                <div className="card-value">
                  {AdminDashboardData.data?.stats?.totalRequests  }
                </div>
            ...
            <div className="dashboard-card">
              ...
              {AdminDashboardData.data?.recentActivities ? (
                <div className="activity-list">
                  {AdminDashboardData.data.recentActivities.users
                    ?.slice(0, 10)
                    .map((user, index) => (
                      <div key={`user-${index}`} className="activity-item">
                        ...
                        <div className="activity-content">
                          ...
                          registered as a {user.bloodType} donor
                  ...
                  {AdminDashboardData.data.recentActivities.appointments
                    ?.slice(0, 10)
